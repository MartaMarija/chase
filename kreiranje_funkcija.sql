...
CREATE OR REPLACE FUNCTION public.dohvati_broj_cr(text[])
 RETURNS TABLE(broj_cr bigint)
 LANGUAGE plpgsql
AS $function$
declare
...
begin
	for i in 1..broj_atributa-1 loop
		string_za_raspisane_atribute := concat(string_za_raspisane_atribute,$1[i], ' LIKE ''%0%'' and ');
	end loop;
		string_za_raspisane_atribute := concat(string_za_raspisane_atribute,$1[broj_atributa], ' LIKE ''%0%'';');
...
CREATE OR REPLACE FUNCTION public.dohvati_broj_cs(text)
 RETURNS TABLE(broj_cs bigint)
 LANGUAGE plpgsql
AS $function$
declare
...
begin
	for i in 1..duljina_desne_strane-1 loop
		string_za_raspisane_atribute := concat(string_za_raspisane_atribute, desna_strana[i], ' LIKE ''%0%'' and ');
	end loop;
		string_za_raspisane_atribute := concat(string_za_raspisane_atribute, desna_strana[duljina_desne_strane], ' LIKE ''%0%'';');
...
CREATE OR REPLACE FUNCTION public.izvrsi_modifikacije_temeljem_zavisnosti_spoja(text[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.dohvati_broj_podudaranja(text, text)
 RETURNS TABLE(broj_podudaranja bigint)
 LANGUAGE plpgsql
AS $function$
declare
...
CREATE OR REPLACE FUNCTION public.vrati_skup_atributa(text[], text)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.dohvati_lijevu_stranu_char(text, text)
 RETURNS TABLE(lijeva_strana2 character varying)
 LANGUAGE plpgsql
AS $function$
DECLARE 
...
CREATE OR REPLACE FUNCTION public.dohvati_lijevu_stranu_text(text, text)
 RETURNS TABLE(lijeva_strana2 text)
 LANGUAGE plpgsql
AS $function$
DECLARE 
	lijeva_strana varchar[] := string_to_array($1, ' ');
...
CREATE OR REPLACE FUNCTION public.izvrsi_modifikacije_temeljem_funkcijske_zavisnosti(text, text, text)
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.popuni_pocetnu_tablicu(text[], text[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.vrati_drugu_dekompoziciju_viseznacne_zavisnosti(text[], text)
 RETURNS text
 LANGUAGE plpgsql
AS $function$
declare
...
CREATE OR REPLACE FUNCTION public.napravi_pocetnu_tablicu(text[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.provjeri_viseznacne_zavisnosti(text[], text[])
 RETURNS void
 LANGUAGE plpgsql
AS $function$
declare 
...
CREATE OR REPLACE FUNCTION public.chase_algoritam(text[], text[], text[], text[], text[], text)
 RETURNS boolean
 LANGUAGE plpgsql
AS $function$
DECLARE 
